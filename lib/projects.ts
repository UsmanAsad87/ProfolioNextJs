...
export const projects: Project[] = [
  ...
  },
  {
    ...
    year: "2025",
    headline: "Real-time machine telemetry for 1,000+ users — API latency cut 10s to 2s.",
    summary:
      "An industrial Machine Monitoring System: ASP.NET Core + PostgreSQL microservices streaming live telemetry over SignalR, predictive-maintenance alerts across WhatsApp, SMS and email, and Keycloak-secured dashboards.",
    solution: [
      "Microservices on ASP.NET Core + PostgreSQL with Clean Architecture, delivered via Agile sprints.",
      "Real-time data streaming over SignalR with Redis and RabbitMQ brokering to Flutter clients.",
      "Predictive-maintenance module with scheduled Celery jobs and multi-channel alerts (WhatsApp, SMS, email).",
      "Keycloak (JWT/RBAC) for 1,000+ users; API performance optimized from 10s to 2s; Docker + Azure CI/CD.",
    ],
    outcome: "Analytics dashboards, reports and billing cut manual reporting effort by 40%.",
    stack: ["ASP.NET Core", "PostgreSQL", "SignalR", "Redis", "RabbitMQ", "Hangfire", "Keycloak", "Flutter", "Azure"],
    facts: [
      { label: "Users", value: "1,000+" },
      { label: "API latency", value: "10s → 2s" },
