...
const RecentProject = () => {
    return (
        <>
            <SEO title="Projects - Usman Asad" description="Browse the recent projects of Usman Asad, highlighting work at Digifyr and NESCOM." />
                        ...
                        justify-center sm:w-[570px] w-[80vw]'>
                            ...
                            <PinContainer title={link} href={link}>
                                <div className='flex items-center justify-center w-[80vw] sm:w-[570px] overflow-hidden mb-10'>
                                    <Image src={img} alt={title} className='rounded-2xl w-auto h-auto' width={570} height={400} />
                                </div>
